        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li class="active"><a href="header_adm.php">Inicio</a></li>
           ...
           <!--   <li><a href="#">Contacto</a></li> -->
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="form_registro_adm.php">Nuevo</a></li>
                  <li><a href="consulta_paciente_adm.php">Editar</a></li>
                  <li><a href="consulta_paciente_borrar_adm.php">Eliminar</a></li>
                  <li role="separator" class="divider"></li>
                  <li><a href="listado_paciente_adm.php">Listado</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>  
                 <a href="#"><?php echo "Usuario:".$_SESSION['usuario_mostrar'] ?></a>
                </li>
